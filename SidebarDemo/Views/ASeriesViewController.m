...
@interface ASeriesViewController ()
...
@implementation ASeriesViewController

@synthesize aTableView, barItem, searchBar;
...
- (void)viewDidLoad
{
    ...
    self.aTableView.tableHeaderView = searchBar;
    searchData = [[NSMutableArray alloc] init];
    
    notams = [[NSMutableArray alloc] init];
    notamsConst = [[NSMutableArray alloc] init];
    
    NSURL * url = [NSURL URLWithString:@"https://ais.mn/iproduct/inotam-a.php"];
...

{
    ...
    [tableView setRowHeight:[[self aTableView] rowHeight ]];
